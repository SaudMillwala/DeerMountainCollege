		...
		<div id="blur" class="blurContainer">
			...
			<div class="bg" style="padding-bottom:660px;">
				...
				<section>
					...
					<table style="padding-bottom:10px;width:119%;">
						<tbody style="text-align: center; ">
							<tr colspan="5">
								...
								<td>
									<button onclick="window.location.href = 'ScheduleDataManagerFaculty.php'" class=adminNav; style="background-color:#006a4e;font-size:80%;margin-top:0px;height:58px;">Schedule<br>Manager</button>
								</td>
								<td>
                    ...
                    <table id="scheduleDataManagerFaculty" style="display:block;">
                        <tr><td>
						...
						<tbody>
							<tr>
								<td>
									<form action="ScheduleDataManagerFaculty.php" method="POST">
