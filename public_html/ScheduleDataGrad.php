		...
		<div id="blur" class="blurContainer">
			...
			<div class="bg" style="padding-bottom:700px">
				...
				<section>
                    ...
                    <table style="padding-bottom:10px;width:120%;">
					    <tbody style="text-align: center; ">
						    <tr colspan="5">
							    ...
							    <td>
								    <button onclick="window.location.href = 'ScheduleDataGrad.php'" class=adminNav; style="background-color:#006a4e;font-size:80%;margin-top:0px;height:58px;">My Schedule</button>
							    </td>
							    <td>
                    ...
                    <form action = "ScheduleDataGrad.php" method = "POST">
                    <table>
                                ...
                                <td>
                                    <?php
                                        ...
                                        { 
                                            if(0 == $semDates++)
                                            {
                                               echo "Semester Start Date: ".$row["start_Date"]."<br>";
                                               echo "Semester End Date: ".$row["end_Date"]."<br><br>"; 
                                                
                                            }
                                            
                                            
                                            echo "Course: ".$row["course_ID"]." - ".$row["course_Name"]." | "."Credits: ".$row["course_Credit"]." | ".$row["semester_Name"]."<br>";
                                            echo "Faculty: ".$row["first_Name"]." ".$row["last_Name"]."<br>";
                                            echo "Room: ".$row["room_ID"]."<br>";
                                            echo "CRN: ".$row["CRN"]."<br>";
                                            echo "Days: ".$row["week_Day"]."<br>";
                                            echo "Start Time: ".$row["start_Time"]." - ".$row["end_Time"]."<br><br>";
