                            ...
                            <tbody><br>
                                ...
                                <?php
                                    ...
                                    {    
                                        ...
                                        $result1 = $pdo->query('SELECT * FROM course WHERE course.dept_ID = "'.$_POST["department"].'" && course.course_ID NOT IN (SELECT course.course_ID FROM course, course_prerequisite WHERE course.course_ID = course_prerequisite.course_ID AND course.dept_ID = "'.$_POST["department"].'");
                                        ');
