				...
				<section>
					...
					<table style="padding-bottom:10px;width:119%;">
						<tbody style="text-align: center; ">
							<tr colspan="6">
								...
								<td>
									<button onclick="window.location.href = 'StudentDegreeAudit.php'" class=adminNav; style="background-color:#006a4e;font-size:80%;margin-top:0px;height:58px;">Student<br>Degree Audit</button>
								</td>
								<td>
                   ...
                   <table>
                        <thead>
                            <tr>
                                <th>
                                    <form action = "StudentDegreeAudit.php" method = "POST">
