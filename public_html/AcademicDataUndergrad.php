		...
		<div id="blur" class="blurContainer">
			...
			<div class="bg" style="padding-bottom:700px">
				...
				<section>
                    ...
                    <table style="padding-bottom:10px;width:120%;">
					    <tbody style="text-align: center; ">
						    <tr colspan="5">
							    ...
							    <td>
								    <button onclick="window.location.href = 'AcademicDataUndergrad.php'" class=adminNav; style="background-color:#006a4e;font-size:80%;margin-top:0px;height:58px;">Academic<br>Information</button>
							    </td>
							    <td>
                    ...
                    <form action = "AcademicDataUndergrad.php" method = "POST">
								...
								<td>
    							    ...
    							    <?php
        							    if(isset($_POST["schedule_search"]))
        							    {
    							            ...
    							            if(isset($_POST["schedule_seats"]))
    							        {
    							            if ($_POST["filter_seats"] == null)
    							            {
    							                echo '<i style="color:RED;font-size:20px;font-family:calibri;x;"><br>*Please Select A Class To Filter By*</i>';
    							    ...
    							    <?php
    							             ...
    							             if(isset($_POST["filter_courses"]))
    							        {
    							            ...
    							            {
    							                echo '<i style="color:RED;font-size:20px;font-family:calibri;x;"><br>*Please Select A Course To Filter By*</i>';
