					...
					<table style="padding-bottom:10px;width:119%;">
						<tbody style="text-align: center; ">
							<tr colspan="5">
								...
								<td>
									<button onclick="window.location.href = 'StudentTranscriptFaculty.php'" class=adminNav; style="background-color:#006a4e;font-size:80%;margin-top:0px;height:58px;">Student<br>Transcripts</button>
								</td>
								<td>
                    ...
                    <table id="studentTranscript" style="display:block;">
					    ...
					    <div id="showStudentTranscript" style="margin-bottom:50px;display:none;">
						    ...
						    <tbody>
							    <tr>
								    <td>
								        <form action = "StudentTranscriptFaculty.php" method = "POST">
